package June.Replit.ArrayList;

import java.util.ArrayList;
import java.util.Scanner;

public class DelieveryCalc {
    public static int refuel_times(ArrayList<Integer> deliveries, int max_fuel) {
        ...
        return total;
//            if (deliveries.get(i) +reminder >= max_fuel) {
//                total += (reminder+ deliveries.get(i)) / max_fuel;
//                reminder=0;
//            } else {
//                reminder = deliveries.get(i) % max_fuel;
