...
public class MultiDimensionalArray1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(arr2D.length); //output: 3

        System.out.println( Arrays.deepToString(arr2D) ); //[[1, 2, 3], [4, 5], [6, 7, 8]] deep only for multiply array

        System.out.println(Arrays.toString( arr2D[1] ) );  // {4,5} toString only for single array

        System.out.println( arr2D[1][1] ); //5 element
