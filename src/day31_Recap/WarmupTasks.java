...
public class WarmupTasks {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isAnagram(s1, s2)); //false
        ...
        System.out.println(result);//A3B2C4
        ...
        System.out.println(result2); //M7N7H7Y5T3R2E3
    ...
    public static String removeDup(String str) { // "AABBBCC"
        ...
        for (char ch : str.toCharArray()) { //{'A', 'A', 'B', 'B', 'B', 'C', 'C'}
            ...
            if (!result.contains("" + ch)) {  //result.indexOf(ch) < 0
                // if the character is not contained in the result, then concatenate the character
                result += ch;
            }
