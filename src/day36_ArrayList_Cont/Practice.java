...
public class Practice {
    public static void main(String[] args) {
        ...
        //.remove can not used in for loop
        System.out.println(list);//[1, 1, 2, 2, 2, 2, 3, 3, 4, 4, 4, 4, 5, 6, 6, 6, 7, 8, 8]
        ...
        System.out.println(names); //[Merve, Komiljon, Fhilipp]
...
*/
        ...
        System.out.println(words);//[Java, Python, Cybertek]
