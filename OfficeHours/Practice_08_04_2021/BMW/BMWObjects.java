...
public class BMWObjects {
    public static void main(String[] args) {
        ...
        bmws[0].setInfo("BMW","x5","white",20000,10000,LocalDate.of(2015,5,20));

        bmws[1].setInfo("BMW","3 Series","black",40750,15000,LocalDate.of(2020,1,10));

        bmws[2].setInfo("BMW","x3","grey",31950,20000,LocalDate.of(2019,2,8));

        bmws[3].setInfo("BMW","x6","red",25000,22000,LocalDate.of(2016,3,3));

        bmws[4].setInfo("BMW","i8","silver",31000,40000,LocalDate.of(2015,4,14));

        bmws[5].setInfo("BMW","x4","white",38000,30210,LocalDate.of(2018,6,26));

        bmws[6].setInfo("BMW","i8","black",45000,5000, LocalDate.of(2021,7,30));
