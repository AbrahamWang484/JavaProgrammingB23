...
public class BrowserTask {
    ...
    boolean isBrowserOpen=false;
        ...
        String operateingSystem = scan.next();
    //try to open
    if (!isBrowserOpen){
        switch(browserName){
            case"chrome":
            ...
            case"firefox":
            case "remote-chrome":
                System.out.println("Browser is opened successfully with "+browserName+" in "+ operateingSystem);

            case "ie":
            case"edge":

                if(operateingSystem!="mac"){
                    System.out.println("Browser is opened successfully with "+browserName+" in "+ operateingSystem);
                }else {
                    System.out.println("Your "+operateingSystem +" doesn't support "+browserName);
                }

            case "sarafi":
                if(operateingSystem!="windows"){
                    System.out.println("Browser is opened successfully with "+browserName+" in "+operateingSystem);

                }
                else
                {
                    System.err.println("Your "+operateingSystem+" doesn't support "+browserName);
        ...
        System.err.println("Browser is already opened with "+browserName+" in "+operateingSystem);
    }
    }
}
/*
